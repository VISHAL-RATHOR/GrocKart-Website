...
const CategoryPage = ({title, bgImage, categories=[]}) => {
       ...
       let filteredItems = categories.includes('All') ? categorypage : categorypage.filter(item=> categories.includes(item.category))



         const renderProduct=  filteredItems.map(categorypage=>{
            return(
                <Cards image={categorypage.image} name={categorypage.name}  price={categorypage.price} />
            )
 } )
